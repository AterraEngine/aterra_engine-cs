...
file static class Entity_AutoGenerated {
    public static Guid Entity_SomeComponent_KeyedInstance_Id = Guid.Parse("458ebce3-a1b2-4966-8ac2-656c4687881d");
}
...
public partial class Entity {
    ...
    public override void Initialize(OmniaId assetId) {
        ...
        if (library.FindOrCreateAsset<ISomeComponent>(Entity_AutoGenerated.Entity_SomeComponent_KeyedInstance_Id)) is not {IsT: true, AsT: {} someComponent }) throw new Exception("Could not create ExampleComponent");
