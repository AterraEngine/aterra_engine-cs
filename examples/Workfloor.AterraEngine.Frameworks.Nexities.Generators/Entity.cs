...
public static class EntityRegistration {
    ...
    public static IServiceCollection AddEntities(IServiceCollection services) {
        services.AddTransient<IEntity>(provider => {
            var omniaLibrary = provider.GetRequiredService<IOmniaLibrary>();
            if (!omniaLibrary.TryGetFromPool<IEntity>(output: out var newEntity, createFactory: static omniaLib => Entity.CreateNewInstance(omniaLib))) {
...
public partial class Entity {
    ...
    public static Entity CreateNewInstance(IOmniaLibrary omniaLibrary) {
        ...
        if (!entity.TryRegisterComponent<ISomeComponent>(omniaLibrary.GetByQuery<ISomeComponent>(instanceId: Entity_AutoGenerated.Entity_SomeComponent_KeyedInstance_Id))) {
            throw new Exception("Could not register ExampleComponent");
        }
