...
public static class CachedSymbolConvertorExtensions {
    ...
    public static bool EqualsNexitiesEntity(this CachedSymbolConvertor self, INamedTypeSymbol? left) => left is not null && self.EqualsSymbol(left, SymbolNames.NexitiesEntity_DisplayString);
    ...
    public static bool EqualsOmniaId(this CachedSymbolConvertor self, INamedTypeSymbol? left) => left is not null && self.EqualsSymbol(left, SymbolNames.OmniaIdAttribute_DisplayString);
}
