...
public static class DependencyInjection {
    public static IEngineConfiguration AddDefaultServices(
    ...
    public static IEngineConfiguration AddStaticServices(
        this IEngineConfiguration configuration,
        params ServiceDescriptor[] serviceDescriptors
    ) {
    ...
    public static IEngineConfiguration BuildDependencyInjectionContainer(this IEngineConfiguration configuration) {
        ...
        logger.Information("Starting to assign Injectable Services ...");
