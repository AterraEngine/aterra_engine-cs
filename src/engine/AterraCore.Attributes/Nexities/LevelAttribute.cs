...
[UsedImplicitly, ExcludeFromCodeCoverage] public class LevelAttribute<TInterface>(string assetId, CoreTags coreTags = CoreTags.Level, ServiceLifetime lifetime = ServiceLifetime.Transient) : LevelAttribute(assetId, coreTags, lifetime, typeof(TInterface));
[UsedImplicitly, ExcludeFromCodeCoverage] public class LevelAttribute<T1, T2>(string assetId, CoreTags coreTags = CoreTags.Level, ServiceLifetime lifetime = ServiceLifetime.Transient) : LevelAttribute(assetId, coreTags, lifetime, typeof(T1), typeof(T2));
[UsedImplicitly, ExcludeFromCodeCoverage] public class LevelAttribute<T1, T2, T3>(string assetId, CoreTags coreTags = CoreTags.Level, ServiceLifetime lifetime = ServiceLifetime.Transient) : LevelAttribute(assetId, coreTags, lifetime, typeof(T1), typeof(T2), typeof(T3));
[UsedImplicitly, ExcludeFromCodeCoverage] public class LevelAttribute<T1, T2, T3, T4>(string assetId, CoreTags coreTags = CoreTags.Level, ServiceLifetime lifetime = ServiceLifetime.Transient) : LevelAttribute(assetId, coreTags, lifetime, typeof(T1), typeof(T2), typeof(T3), typeof(T4));
[UsedImplicitly, ExcludeFromCodeCoverage] public class LevelAttribute<T1, T2, T3, T4, T5>(string assetId, CoreTags coreTags = CoreTags.Level, ServiceLifetime lifetime = ServiceLifetime.Transient) : LevelAttribute(assetId, coreTags, lifetime, typeof(T1), typeof(T2), typeof(T3), typeof(T4), typeof(T5));
[UsedImplicitly, ExcludeFromCodeCoverage] public class LevelAttribute<T1, T2, T3, T4, T5, T6>(string assetId, CoreTags coreTags = CoreTags.Level, ServiceLifetime lifetime = ServiceLifetime.Transient) : LevelAttribute(assetId, coreTags, lifetime, typeof(T1), typeof(T2), typeof(T3), typeof(T4), typeof(T5), typeof(T6));
[UsedImplicitly, ExcludeFromCodeCoverage] public class LevelAttribute<T1, T2, T3, T4, T5, T6, T7>(string assetId, CoreTags coreTags = CoreTags.Level, ServiceLifetime lifetime = ServiceLifetime.Transient) : LevelAttribute(assetId, coreTags, lifetime, typeof(T1), typeof(T2), typeof(T3), typeof(T4), typeof(T5), typeof(T6), typeof(T7));
