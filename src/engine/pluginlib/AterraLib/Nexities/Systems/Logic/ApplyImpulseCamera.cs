...
// Code
// ---------------------------------------------------------------------------------------------------------------------
[System(AssetIdLib.AterraLib.SystemsLogic.ApplyImpulseCamera, CoreTags.LogicSystem)]
...
public class ApplyImpulseCamera : NexitiesSystemWithFilter<ICamera2D> {
    ...
    public override void Tick(ActiveLevel level) {
        foreach (ICamera2D entity in GetEntities(level)) {
            Vector2 scaledTranslationOffset = entity.Impulse2D.TranslationOffset / entity.RaylibCamera2D.Camera.Zoom * 10;
