...
public static class ServiceCollectionExtensions {
    public static IServiceCollection AddContinuum(this IServiceCollection serviceCollection, Action<IScopedProvider, IContinuumServiceFactory> configure) {
        ...
        serviceCollection.AddSingleton<IContinuumServiceFactoryConfiguration>(new ContinuumConfiguration(configure));
