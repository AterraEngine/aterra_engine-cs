...
public static class AnsiColors {
    ...
    static AnsiColors() {
        ...
        _dictionary.Add("rose", new ByteVector3(255, 97, 136));
    ...
    public static ByteVector3 GetColor(string colorName) =>
        _dictionary.TryGetValue(colorName, out ByteVector3 color)
            ? color
    ...
    public static bool AddColor(string colorName, ByteVector3 value) => _dictionary.TryAdd(colorName, value);
}