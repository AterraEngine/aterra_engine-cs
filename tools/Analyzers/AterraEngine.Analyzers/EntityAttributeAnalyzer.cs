...
public class EntityAttributeAnalyzer : DiagnosticAnalyzer {
    ...
    private static readonly DiagnosticDescriptor Rule = new(
        DiagnosticId, 
        title: new LocalizableResourceString(nameof(Resources.AE0001Title), Resources.ResourceManager, typeof(Resources)), 
        messageFormat: new LocalizableResourceString(nameof(Resources.AE0001MessageFormat), Resources.ResourceManager, typeof(Resources)), 
        category: Category,
        defaultSeverity: DiagnosticSeverity.Error, 
        isEnabledByDefault: true, 
        description: new LocalizableResourceString(nameof(Resources.AE0001Description), Resources.ResourceManager, typeof(Resources))
    );
